...
import NotificacionesScreen from './screens/tendero/NotificacionesScreen';
      ...
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen
            ...
            options={({ navigation }) => ({ title: 'Notificaciones', headerLeft: () => <BotonVolver navigation={navigation} /> })}
          />
