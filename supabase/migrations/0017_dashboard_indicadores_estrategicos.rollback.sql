...
drop function if exists admin_idc_por_comercio();

-- Revierte las 4 RPCs de 0011 a su versión sin resuelto_at.
...
alter table proveedores_sugeridos drop column if exists resuelto_at;
alter table productos_sugeridos drop column if exists resuelto_at;
